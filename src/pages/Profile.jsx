...
const Profile = () => {
  ...
  () => {
    ...
    //   setUserPhoto(downloadURL);
      ...
      user?.UserImg&&userRequest(user.token).put(`/users/update/${user._id}`, {UserImg:downloadURL})
    });
  }
);
    }
  return (
    <>
        <NavBar/>
        <Wrapper className="container p-5  d-flex justify-content-center align-items-center">
            ...
            <BodyContainer className='shadow shadow-1 p-3 border border-1'>
                ...
                <Sell className='text-center text-primary shadow shadow-1 rounded-3'>
                    <h3 className='fw-bold'>Do you have products to sell?</h3>
